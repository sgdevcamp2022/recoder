...
import com.recoder.presentation.socketDTO.Peer;
import com.recoder.presentation.socketDTO.PeerUpdateInfo;
import com.recoder.presentation.socketDTO.Peers;
...
public class RoomStore {
    ...
    private SupplierMutableLiveData<Producers> producers = new SupplierMutableLiveData<>(Producers::new);
    private SupplierMutableLiveData<Peers> peers = new SupplierMutableLiveData<>(Peers::new);
    private SupplierMutableLiveData<Consumers> consumers = new SupplierMutableLiveData<>(Consumers::new);
    ...
    public void addPeer(Peer peer) {
        peers.postValue(peersInfo -> peersInfo.addPeer(peer));
    }
    ...
    public void updatePeerInfo(PeerUpdateInfo info) {
        peers.postValue(peers -> peers.updatePeerIndo(info));
    }

    public void setRoomPeerCount(Integer count) {
        roomInfo.postValue(roomInfo -> roomInfo.setPeerCount(count));
    }
